...
1. 到本仓库 [Releases](https://github.com/764861388-cloud/obsidian-pdf-annotate/releases) 下载最新版 `PDF-Annotate-<version>.zip`；
2. 解压得到 `PDF Annotate/` 文件夹（内含 main.js、manifest.json、styles.css）；
